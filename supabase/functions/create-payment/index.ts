...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    console.log("Creating Chargily payment with data:", {
      productId,
      productName,
      amount,
      customerEmail,
    ...
    // Create payment request to Chargily using REST API (more reliable for direct amounts)
    const paymentData = {
      mode: "payment",
    ...
    console.log("Sending request to Chargily API:", paymentData);
