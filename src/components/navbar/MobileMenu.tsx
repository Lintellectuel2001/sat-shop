      ...
      <div className="container mx-auto px-4 py-6 bg-sky-500">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="space-y-4">
            <Link to="/" className="block text-lg font-medium text-primary hover:text-accent transition-colors" onClick={onClose}>
              Accueil
            </Link>
            <Link to="/marketplace" className="block text-lg font-medium text-primary hover:text-accent transition-colors" onClick={onClose}>
              Marketplace
            </Link>
            <Link to="/contact" className="block text-lg font-medium text-primary hover:text-accent transition-colors" onClick={onClose}>
              Contactez-nous
            </Link>
          </div>
          ...
          <div className="space-y-4">
            {isLoggedIn ? <>
                <Link to="/profile" className="flex items-center gap-3 text-primary hover:text-accent transition-colors" onClick={onClose}>
                  <UserCog size={20} />
              ...
              onClose();
                ...
                <Link to="/login" className="flex items-center gap-3 text-primary hover:text-accent transition-colors" onClick={onClose}>
                  <User size={20} />
                  <span className="text-lg font-medium">Connexion</span>
                </Link>
              </>}

            <Link to="/cart" className="flex items-center gap-3 text-primary hover:text-accent transition-colors" onClick={onClose}>
